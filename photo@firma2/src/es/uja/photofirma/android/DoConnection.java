...
/**
 * Esta clase se invoca cada vez que se pretende realizar una una conexión.
 * Pemite el uso de http o https, en función de la dirección con la que se pretende establecer conexión, ademas
 * permite la seleccion de un determinado timeout.
 *
